...
let friends = '상원,다영,주현,수양,지수'.split(',');
...
//push, unshift : length를 반환함 ~
let unshift = friends.unshift('노아');
let push = friends.push('밤비');

// 배열 요소 제거

//.shift.shift 안됨 사유: 문자를 return 하기 때문이죵 ㅎ
